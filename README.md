...
src/
  ...
  services/email — email service and provider adapters
  components/ — UI primitives and component library
  emails/ — email templates
config and tooling: next.config.ts, tsconfig.json, components.json
```
